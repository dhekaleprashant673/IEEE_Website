...
const organizingCommittee: CommitteeMember[] = [
  ...
  { index: 3, name: 'Dr. A. O. Mulani', designation: 'H.O.D, ENTC', role: 'Conference Convener' },
  { index: 4, name: 'Prof. N. M. Sawant', designation: 'IQAC Co-ordinator, SKNSCOE, Pandharpur', role: 'Conference Convener' },
  { index: 5, name: 'Dr. S. D. Raut', designation: 'PAH Solapur University Solapur, India.', role: 'Conference Convener' },
  { index: 6, name: 'Dr. S. G. Kulkarni', designation: 'Vice Principal', role: 'Committee Member' },
  { index: 7, name: 'Dr. S. G. Deshmukh', designation: 'Dean (Publication)', role: 'Committee Member' },
  { index: 8, name: 'Dr. S. S. Kulkarni', designation: 'Dean (Academic), H.O.D. (MECH)', role: 'Committee Member' },
  { index: 9, name: 'Dr. C. P. Pise', designation: 'Dean (Admin)', role: 'Committee Member' },
  { index: 10, name: 'Dr. B. S. Gandhare', designation: 'Dean (PG) and EDP', role: 'Committee Member' },
  { index: 11, name: 'Dr. B. B. Godbole', designation: 'Dean (Research)', role: 'Committee Member' },
  { index: 12, name: 'Dr. S. S. Kadam', designation: 'HOD (Civil)', role: 'Committee Member' },
  { index: 13, name: 'Dr. S. D. Katekar', designation: 'Dean (Training and Placement)', role: 'Committee Member' },
  { index: 14, name: 'Dr. Kondooru Shivashanker', designation: 'H.O.D.& Associate Professor (Electrical Engineering)', role: 'Committee Member' },
  { index: 15, name: 'Dr. A. I. Nikam', designation: 'Dean (Student Affair), H.O.D. (GSE)', role: 'Committee Member' },
  { index: 16, name: 'Prof. S. G. Linge', designation: 'Assistant Professor (CSE)', role: 'Conference Co-Convener' },
  { index: 17, name: 'Prof. S. R. Takale', designation: 'Assistant Professor (ENTC)', role: 'Conference Co-Convener' },
];
...
const technicalCommittee: TechnicalMember[] = [
  ...
  { index: 29, name: 'Dr. A. R. Shinde', affiliation: 'Punyashlok Ahilyadevi Holkar Solapur University, Solapur, India' },
  { index: 30, name: 'Dr. Vikas T. Humbe', affiliation: 'School of Technology, SRTM University, Latur, India' },
  { index: 31, name: 'Dr. Ramesh R. Manza', affiliation: 'Department of Computer Science and Information Technology, Dr. Babasaheb Ambedkar Marathwada University, Aurangabad, India' },
  { index: 32, name: 'Dr. P. L. Yannawar', affiliation: 'Department of Computer Science & Information Technology, Dr. Babasaheb Ambedkar Marathwada University (BAMU), Chhatrapati Sambhajinagar, India' },
  { index: 33, name: 'Dr. Vijay Kumbhar', affiliation: 'Department of Computer Science, Shivaji University, Kolhapur, India' },
  { index: 34, name: 'Dr. D. B. Kulkarni', affiliation: 'Walchand College of Engineering, Sangli, India' },
  { index: 35, name: 'Dr. B. F. Momin', affiliation: 'Walchand College of Engineering, Sangli, India' },
  { index: 36, name: 'Dr. V. K. Bairagi', affiliation: 'AISSMS Institute of Information Technology, Pune, India' },
  { index: 37, name: 'Dr. Vaishali S. Jadhav', affiliation: 'Ramrao Adik Institute of Technology, D. Y. Patil University Campus, Mumbai, India' },
  { index: 38, name: 'Dr. Gaurav Dhiman', affiliation: 'Jagat Guru Nanak Dev Punjab State Open University, Patiala' },
];
